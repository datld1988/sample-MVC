...
public class AuthenResponseData  extends com.vtc.ws.v2.model.ResponseData  implements java.io.Serializable {

	@Override
	public String toString() {
		return "AuthenResponseData [getResponseCode()=" + getResponseCode() + ", getDescription()=" + getDescription() + ", accessToken=" + accessToken + ", accountID=" + accountID + ", accountName="
				+ accountName + ", balance=" + balance +  ", getExtend()="
				+ getExtend() + ",  ]";
	}
    ...
    /**
     * Gets the accessToken value for this AuthenResponseData.
     * 
     * @return accessToken
     */
    ...
    /**
     * Sets the accessToken value for this AuthenResponseData.
     * 
     * @param accessToken
     */
    ...
    /**
     * Gets the accountID value for this AuthenResponseData.
     * 
     * @return accountID
     */
    ...
    /**
     * Sets the accountID value for this AuthenResponseData.
     * 
     * @param accountID
     */
    ...
    /**
     * Gets the accountName value for this AuthenResponseData.
     * 
     * @return accountName
     */
    ...
    /**
     * Sets the accountName value for this AuthenResponseData.
     * 
     * @param accountName
     */
    ...
    /**
     * Gets the balance value for this AuthenResponseData.
     * 
     * @return balance
     */
    ...
    /**
     * Sets the balance value for this AuthenResponseData.
     * 
     * @param balance
     */
    ...
    /**
     * Gets the lastLoginTime value for this AuthenResponseData.
     * 
    ...
    /**
     * Sets the lastLoginTime value for this AuthenResponseData.
     * 
     * @param lastLoginTime
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AuthenResponseData)) return false;
        AuthenResponseData other = (AuthenResponseData) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AuthenResponseData.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/VTCApp.WcfService.BankModels", "AuthenResponseData"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/VTCApp.WcfService.BankModels", "LastLoginTime"));
