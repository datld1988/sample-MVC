...
public class RequestData  implements java.io.Serializable {
    ...
    /**
     * Gets the sign value for this RequestData.
     * 
     * @return sign
     */
    ...
    /**
     * Sets the sign value for this RequestData.
     * 
     * @param sign
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/VTCApp.WcfService.BankModels", "RequestData"));
